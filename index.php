    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="?page=dashboard">
        <div class="sidebar-brand-icon ">
          <img src="assets/img/stimik.png" ></img>
        </div>
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
            ...
            <span style="color: white;">Data Mahasiswa</span>
          </a>
          <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <h6 class="collapse-header">Details:</h6>
              <a class="collapse-item" href="?page=informasi"><i class="#"> </i> Informasi Mahasiwa </a>
              <a class="collapse-item" href="?page=nilai"><i class="#"> </i> Nilai </a>
        ...
        <li class="nav-item">
          <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
            <i class="fas fa-fw fa-solid fa-hashtag"></i>
            <span style="color: white;">Kode</span>
          </a>
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <h6 class="collapse-header">Details:</h6>
              <a class="collapse-item" href="?page=matakuliah"><i class="#"> </i> Mata Kuliah </a>
              <a class="collapse-item" href="?page=prodi"><i class="#"> </i> Prodi </a>
              <!-- <a class="collapse-item" href="cards.html">Cards</a> -->
            </div>
          </div>
        </li>
